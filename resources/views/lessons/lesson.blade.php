    ...
    @if(isset($breadcrumb))
        <div class="imagina-breadcrumb {{(isset($lesson->externalurl) && !empty($lesson->externalurl) && $lesson->externalurl)?"externalurl":""}}">
            <div class="breadcrumb-wrapper">
                ...
                <a class="breadcrumb-item" href="{{route("level",["type"=>$level->type,"level_slug"=>$level->slug])}}">
...
@section("scripts")
    <script type="text/javascript" src="{{asset("js/recorder.js?v=2")}}"></script>
    <script>
        ...
        $(document).ready(function(){
            ...
            function lessonchange(element){
                ...
                $.post( "{{route("lesson_complete")}}",{"_token":"{{csrf_token()}}","lesson":"{{$lesson->id}}"}, function( data ) {
