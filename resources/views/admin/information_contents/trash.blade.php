...
@section("content")
    ...
    @if(isset($breadcrumb))
        ...
        <div class="main-content-wrapper {{isset($breadcrump)?"main-content-wrapper-breadcrumb":""}}" id="trash_action">
            ...
            <h1>Delete Information Contents</h1>

            <div>
                <p>Are you sure you want to delete the Information Contents {{$information_content->name}}?</p>
                <p>Write DELETE to continue</p>
            </div>

            <form action="{{route("admin_information_contents_delete")}}" method="post" >
                {{ csrf_field() }}
