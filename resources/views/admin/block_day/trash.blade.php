...
@section("content")
    @if(isset($breadcrumb))
        <div class="imagina-breadcrumb">
            <div class="breadcrumb-wrapper">
                <a class="breadcrumb-item" href="{{route("admin_block_day")}}">
                    Blocked Day <i class="fa fa-angle-right" aria-hidden="true"></i>
                </a>
        ...
        <div class="main-content-wrapper {{isset($breadcrump)?"main-content-wrapper-breadcrumb":""}}" id="trash_action">
            ...
            <h1>Delete Blocked Day</h1>

            <div>
                <p>Are you sure you want to delete the Blocked Day?</p>
                <p>Write DELETE to continue</p>
            </div>

            <form action="{{route("admin_block_day_delete")}}" method="post" >
                {{ csrf_field() }}
