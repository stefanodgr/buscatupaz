    ...
    <div class="row top-row div-max-res">
        <div class="col-xs-12 col-sm-8 text-left">
            <div class="container menu-first-step">
                ...
                <b class="item-first-step item-step-active item-three">Your {{ __('Basic Info') }}</b>
    ...
    <div class="main-menu menu-inmersion">
        <div class="main-menu-header header-inmersion">
            ...
            <div class="text-right btn-step-immersion">
                <button class="btn btn-primary btn-next-step btn-res">{{ __('Next Step') }}</button>
            </div>
        </div>
        @include("inmersion.includes.menu.immersion_third_step")
    </div>
</div>